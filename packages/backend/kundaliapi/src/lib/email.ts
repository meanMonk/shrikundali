...
<body style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 2rem;">
  ...
  <p style="margin-top: 2rem; font-size: 0.9rem; color: #666;">This link will remain active for 7 days. If you have any issues, reply to this email.</p>
  
  <hr style="border: none; border-top: 1px solid #d4a373; margin: 2rem 0;">
  <p style="font-size: 0.8rem; color: #888; text-align: center;">Generated by Shri Kundali • For guidance, not a substitute for professional advice</p>
</body>
</html>`;
