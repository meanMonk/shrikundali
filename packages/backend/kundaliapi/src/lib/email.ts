...
<body style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 2rem;">
  ...
  <p style="margin-top: 1rem; font-size: 0.9rem; color: #666;">This download link will remain active for 7 days. If you have any issues, email us at <a href="mailto:support@shrikundali.com" style="color: #8b4513">support@shrikundali.com</a>.</p>
